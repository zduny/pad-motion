        ...
        let magic_string = {
            ...
            match string {
                ...
                _ => Err(invalid_data_error(
                    "Magic string is not a valid UTF-8 string",
                )),
            }
        }?;
...
pub fn encode_controller_data_request(
    writer: &mut Vec<u8>,
...
pub fn encode_message_payload(writer: &mut Vec<u8>, message_payload: MessagePayload) -> Result<()> {
    match message_payload {
        ...
        MessagePayload::ProtocolVersion(version) => writer.write_u16::<LittleEndian>(version),
...
pub fn parse_message_payload(
    reader: &mut Cursor<&[u8]>,
    message_source: MessageSource,
    message_type: MessageType,
) -> Result<MessagePayload> {
    match message_source {
        MessageSource::Server => match message_type {
            ...
            MessageType::ConnectedControllers => {
                ...
                if terminating_byte != 0 {
                    ...
                    Ok(MessagePayload::ConnectedControllerResponse { controller_info })
                }
            }
        ...
        MessageSource::Client => match message_type {
            MessageType::ProtocolVersion => Ok(MessagePayload::None),
            MessageType::ConnectedControllers => {
            ...
            MessageType::ControllerData => {
                ...
                Ok(MessagePayload::ControllerDataRequest(
